            ...
            <>
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark " style={{ position: "sticky", top: "-1px", zIndex: "11", padding: "20px 0" }}>
                    <div className="container-fluid">
                        <Link className="navbar-brand fw-bold" style={{ marginRight: "40px", paddingLeft: "10px", fontSize: "25px" }} to="/">NewsMonkey</Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item">
                                    <Link className="nav-link active" style={{ paddingLeft: "10px" }} aria-current="page" to="/">Home</Link>
                                </li>
